                ...
                <form action="{{ route('books.update',$book) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            @enderror
                            <img  alt="" id="cover-image-thumb" class="img-fluid img-thumbnail" src="{{asset('storage/'.$book->cover_image)}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="publish_year" type="number"
                                ...
                                is-invaild
                            @enderror"
                                name="publish_year" value="{{ $book->publish_year }}" autocomplete="publish_year" />
                            @error('publish_year')
                                <span class="invaild-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_pages" type="number"
                                ...
                                is-invaild
                            @enderror"
                                name="number_of_pages" value="{{ $book->number_of_pages }}" autocomplete="number_of_pages" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_copies" type="number"
                                ...
                                is-invaild
                            @enderror"
                                name="number_of_copies" value="{{ $book->number_of_copies }}" autocomplete="number_of_copies" />
