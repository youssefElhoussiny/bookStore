                        ...
                        @auth
                            ...
                            <div class="form text-center mb-2">
                                ...
                                <span class="text-muted mb-3">
                                    <input type="number" class="form-control d-inline mx-auto" id="quantity" name="quantity" value="1" min="1" max="{{$book->number_of_copies}}" style="width:10%" required>
                                </span>
